...
public class DriveFriends {
	public static void main(String [] args)
		...
		Person A = people.addPerson("Michael");
		Person B = people.addPerson("Belal");
		Person C = people.addPerson("Nastassja");
		System.out.println(people.lookup("Nastassja"));
...
//		System.out.println(people.firstPerson.name);
	}
